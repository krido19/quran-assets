...
- **Masalah**: Beberapa fitur seperti "Asmaul Husna", "Doa Harian", dan "Dzikir Pagi & Petang" masih hardcoded dalam Bahasa Indonesia, tidak mengikuti pilihan bahasa aplikasi.
- **Solusi**:
  - **Context API**: Mengintegrasikan `LanguageContext` ke halaman `AsmaulHusna.jsx`, `DailyPrayers.jsx`, dan `DzikirPagiPetang.jsx`.
