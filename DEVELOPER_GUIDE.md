...
### A. Library & Perhitungan Waktu Sholat
...
-   **Jadwal Sholat**: Perhitungan waktu sholat menggunakan library `adhan-js`.

### C. Aset Audio (PENTING)
-   **Murottal (Ayat)**: Audio per-ayat di-stream langsung dari server **Quran.com** (verses.quran.com). Hak cipta rekaman milik masing-masing Qari/Penerbit yang bekerjasama dengan Quran.com.
-   **Doa Harian & Adzan**:
